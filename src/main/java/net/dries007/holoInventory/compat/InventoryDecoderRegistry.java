...
public class InventoryDecoderRegistry {
    ...
    public static final InventoryDecoder DEFAULT = new InventoryDecoder(IInventory.class) {
    ...
    public static void init() {
        if (Loader.isModLoaded("StorageDrawers")) {
            register(new InventoryDecoder(IDrawerGroup.class) {
        ...
        if (Loader.isModLoaded("JABBA")) {
            register(new InventoryDecoder(TileEntityBarrel.class) {
